...
function findSolutions(wordList, firstSet) {
	...
	while (solutionSet.length > 0) {
		...
		solutionSet = nextSolutions(wordList, solutionSet)
	}
...
function nextSolutions(wordList, solutions) {
	let nextSolutions = {}
...
module.exports = {
	init: init,
	reinit: reinit,
	findSolutionsByWord: findSolutionsByWord,
	findSolutionsBySample: findSolutionsBySample,
